 ...
 *      当函数以构造函数形式调用时，构造函数创建的对象中都会有一个隐含属性指向该构造函数的原型对象，我们可以通过__proto__来
 * 访问该属性
 * 
 *      原型对象就相当于一个公共区域，所有同一个类的实例都可以访问到这个原型对象，我们可以将对象中共有的内容，统一设置到原型
 * 对象中
 * 
...
// 使用in检查对象中是否含有某个属性，如果对象没有原型中有，也会返回true
